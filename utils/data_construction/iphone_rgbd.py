...
def read_args():
    ...
    parser.add_argument('--every', type=int, default=5, help="Show only every nth point cloud and coordinate frames. Only used for point cloud and odometry visualization.")
...
def main():
    ...
    if flags.point_clouds:
        pc = point_clouds(flags, data)
        o3d.io.write_point_cloud("stray_point_cloud.ply", pc[0])
    # if flags.integrate:
